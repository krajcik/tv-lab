...
- 12 изображений: ретривер, бобтейл и рэгдолл в двух вариантах, дерево, горы, папоротник, Сатурн, галактика и Луна.
- [100 цитат стоиков](docs/quotes.md): Марк Аврелий, Сенека и Эпиктет, с подписью автора и источником.
...
Проверки 0.3 перечислены в [docs/validation-0.3.md](docs/validation-0.3.md);
