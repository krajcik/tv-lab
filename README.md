...
В Android 0.5.0 доступны [восемь живых сцен для медитации](docs/meditation.md):
от дыхания облака и растущего кристалла до галактики и чёрной дыры. По умолчанию
каждая длится час; доступен бесконечный показ. Картинки и цитаты — отдельный режим.

В режиме галереи: свободное движение → сборка образа → удержание → распад → следующий образ.
