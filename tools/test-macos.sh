...
"$JAVAC" -encoding UTF-8 -d "$OUT" "$SOURCES/ParticleModes.java" "$SOURCES/SceneSource.java" "$SOURCES/SceneCache.java" "$SOURCES/ScenePlaylist.java" "$SOURCES/SceneTimeline.java" "$SOURCES/FlowField.java" "$SOURCES/ParticleEngine.java" "$ROOT/apps/macos-flow/Tests/MetalReference.java"
